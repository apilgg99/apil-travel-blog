...
export const posts: Post[] = [
  {
    ...
    content: [
      "Kyoto is a city that rewards slowness. Arrive early, before the tour groups spill out of coaches, and you'll find temple courtyards wrapped in silence and low morning light.",
  ...
  },
  {
    ...
    content: [
      "Oaxacan food isn't just regional Mexican cuisine — it's a living culinary archive, shaped by indigenous traditions that predate the Spanish by centuries.",
  ...
  },
  {
    ...
    content: [
      "The Annapurna Circuit has changed. Roads now run parallel to sections of the old trail, and some teahouses that once felt remote now sit beside jeep tracks. But the core of the route — the high mountain passes, the river gorges, the Himalayan villages — remains extraordinary.",
  ...
  },
  {
    ...
    content: [
      "The hammam is not a spa. It's something older and more practical: a communal bathhouse that has been at the center of Moroccan social life for centuries. In the medinas of Fez and Marrakech, neighbourhood hammams still operate exactly as they always have.",
  ...
  },
  {
    ...
    content: [
      "Patagonia doesn't ease you in. The moment you step off the bus at Torres del Paine, the wind hits you like a wall. It's the kind of wind that makes you reconsider your life choices, your gear choices, your entire relationship with the outdoors.",
